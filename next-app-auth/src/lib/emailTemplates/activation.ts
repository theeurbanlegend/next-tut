														...
														<tr>
															<td class="pad" style="padding-bottom:35px;padding-left:30px;padding-right:30px;padding-top:35px;width:100%;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 150px;"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/4016/books-plus.png" style="display: block; height: auto; border: 0; width: 100%;" width="150" alt="Books Plus" title="Books Plus"></div>
																</div>
															</td>
														</tr>
													</table>
													...
													<table class="image_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="padding-bottom:5px;padding-left:20px;padding-right:20px;padding-top:5px;width:100%;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 540px;"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/4016/shelf.jpg" style="display: block; height: auto; border: 0; width: 100%;" width="540" alt="book shelf" title="book shelf"></div>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-bottom:20px;padding-left:30px;padding-right:30px;padding-top:20px;">
																<div style="color:#737487;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:18px;line-height:180%;text-align:center;mso-line-height-alt:32.4px;">
																	<p style="margin: 0; word-break: break-word;"><span>You have successfully created an account. Please click on the the button below to activate it.</span></p>
																</div>
															</td>
														</tr>
													</table>
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{url}}" style="height:52px;width:273px;v-text-anchor:middle;" arcsize="8%" stroke="false" fillcolor="#ff7d14">
<w:anchorlock/>
												...
												<td class="column column-1" width="50%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<table class="image_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 195px;"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/4016/book-app.png" style="display: block; height: auto; border: 0; width: 100%;" width="195" alt="audio book" title="audio book"></div>
																</div>
															</td>
														</tr>
													</table>
												...
												<td class="column column-2" width="50%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 40px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<table class="image_block block-1" width="100%" border="0" cellpadding="40" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 110px;"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/4016/book-unlimited.gif" style="display: block; height: auto; border: 0; width: 100%;" width="110" alt="book icon" title="book icon"></div>
																</div>
															</td>
														</tr>
													</table>
